  ...
  return (
    <nav className="flex items-center justify-between px-8 py-5 border-b border-gray-100">
      ...
      <div className="flex items-center gap-6">
        ...
        <Link
          href="/signup"
          className="text-sm bg-amber-500 text-white px-4 py-2 rounded-lg font-semibold shadow-sm hover:bg-amber-600 hover:shadow-md focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600 transition-all"
